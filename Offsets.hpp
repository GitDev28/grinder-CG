...
constexpr long OFF_TRAVERSAL_START_TIME = 0x2b80;             //[Buttons]->m_traversalStartTime
constexpr long OFF_TRAVERSAL_PROGRESS = 0x2b7c;               //[Buttons]->m_traversalProgress
constexpr long OFF_WALL_RUN_START_TIME = 0x3624;              //[Buttons]->m_wallRunStartTime
constexpr long OFF_WALL_RUN_CLEAR_TIME = 0x3628;              //[Buttons]->m_wallRunClearTime
...
constexpr long OFF_TIME_BASE = 0x2098;                        //[RecvTable.DT_Player]->m_currentFramePlayer.timeBase
